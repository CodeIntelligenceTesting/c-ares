# [![c-ci logo](https://c-ci.org/art/c-ci-logo.svg)](https://c-ci.org/)

[![Build Status](https://api.cirrus-ci.com/github/c-ci/c-ci.svg?branch=main)](https://cirrus-ci.com/github/c-ci/c-ci)
[![Windows Build Status](https://ci.appveyor.com/api/projects/status/aevgc5914tm72pvs/branch/main?svg=true)](https://ci.appveyor.com/project/c-ci/c-ci/branch/main)
[![Coverage Status](https://coveralls.io/repos/github/c-ci/c-ci/badge.svg?branch=main)](https://coveralls.io/github/c-ci/c-ci?branch=main)
[![CII Best Practices](https://bestpractices.coreinfrastructure.org/projects/291/badge)](https://bestpractices.coreinfrastructure.org/projects/291)
[![Fuzzing Status](https://oss-fuzz-build-logs.storage.googleapis.com/badges/c-ci.svg)](https://bugs.chromium.org/p/oss-fuzz/issues/list?sort=-opened&can=1&q=proj:c-ci)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=c-ci_c-ci&metric=bugs)](https://sonarcloud.io/summary/new_code?id=c-ci_c-ci)
[![Coverity Scan Status](https://scan.coverity.com/projects/c-ci/badge.svg)](https://scan.coverity.com/projects/c-ci)
...
## Overview
[c-ci](https://c-ci.org) is a modern DNS (stub) resolver library, written in
...
One of the goals of c-ci is to be a better DNS resolver than is provided by
your system, regardless of which system you use.  We recommend using
the c-ci library in all network applications even if the initial goal of
asynchronous resolution is not necessary to your application.

c-ci will build with any C89 compiler and is [MIT licensed](LICENSE.md),
which makes it suitable for both free and commercial software. c-ci runs on
Linux, FreeBSD, OpenBSD, MacOS, Solaris, AIX, Windows, Android, iOS and many
more operating systems.

c-ci has a strong focus on security, implementing safe parsers and data
...
framework, c-ci is constantly validated with a range of static and dynamic
analyzers, as well as being constantly fuzzed by [OSS Fuzz](https://github.com/google/oss-fuzz).

While c-ci has been around for over 20 years, it has been actively maintained
...
[GitHub  repository](https://github.com/c-ci/c-ci).  Our signed releases
are available in the [release archives](https://c-ci.org/download/).
...
[GitHub Issues](https://github.com/c-ci/c-ci/issues) page.

**Discussions** around c-ci and its use, are held on
[GitHub Discussions](https://github.com/c-ci/c-ci/discussions/categories/q-a)
or the [Mailing List](https://lists.haxx.se/mailman/listinfo/c-ci).  Mailing
List archive [here](https://lists.haxx.se/pipermail/c-ci/).
Please, do not mail volunteers privately about c-ci.

**Security vulnerabilities** are treated according to our
[Security Procedure](SECURITY.md), please email c-ci-security at
 haxx.se if you suspect one.


## Release keys

Primary GPG keys for c-ci Releasers (some Releasers sign with subkeys):
...
For each release `c-ci-X.Y.Z.tar.gz` there is a corresponding
`c-ci-X.Y.Z.tar.gz.asc` file which contains the detached signature for the
release.
...
```bash
% gpg -v --verify c-ci-1.29.0.tar.gz.asc c-ci-1.29.0.tar.gz
...
- [RFC6724](https://datatracker.ietf.org/doc/html/rfc6724).
  IPv6 address sorting as used by `ci_getaddrinfo()`.
