...
should be handled in the c-ci project.

Publishing Information
----------------------

All known and public c-ci vulnerabilities will be listed on [the c-ci web
site](https://c-ci.org/vulns.html).
...
- The person discovering the issue, the reporter, reports the vulnerability
  privately to `c-ci-security@haxx.se`. That's an email alias that reaches a
  handful of selected and trusted people.

- Messages that do not relate to the reporting or managing of an undisclosed
  security vulnerability in c-ci are ignored and no further action is
  required.
...
- The project team announces the release and the vulnerability to the world in
  the same manner we always announce releases. It gets sent to the c-ci
  mailing list and the oss-security mailing list.

- The security web page on the web site should get the new vulnerability
  mentioned.

C-CI-SECURITY (at haxx dot se)
--------------------------------

Who is on this list? There are a couple of criteria you must meet, and then we
might ask you to join the list or you can ask to join it. It really isn't very
formal. We basically only require that you have a long-term presence in the
c-ci project and you have shown an understanding for the project and its way
